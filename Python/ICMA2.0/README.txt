...
If both exists, choose one that you like
...
conda install scipy pandas requests opencv matplotlib pillow vtk xlsxwriter
conda install -c conda-forge pydicom diskcache
