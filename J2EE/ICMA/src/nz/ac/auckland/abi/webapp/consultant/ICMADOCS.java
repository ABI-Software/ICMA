...
/**
 * Servlet implementation class ICMADOCS
 */
@WebServlet(description = "Content delivary", urlPatterns = { "/ICMADOCS/*" })
public class ICMADOCS extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response, boolean content)   throws IOException{
		String uri = request.getRequestURI(); // has application name/ICMADOCS/request
		String nodepath = uri.substring(uri.indexOf("/ICMADOCS")+10); //Remove /ICMADOCS/
		try{
