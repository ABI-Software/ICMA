...
public class PasswordManager {
	...
	public Response addAdmin(String req){
		System.out.println(req);
		JSONObject response = new JSONObject();
		try{
			JSONParser parser = new JSONParser();
			JSONObject jreq = (JSONObject)parser.parse(req);
			admin.changeUserPassword((String)jreq.get("username"), (String)jreq.get("oldpassword"),(String)jreq.get("newpassword"));
