 ...
 */
@WebServlet(description = "Content delivary", urlPatterns = { "/ICMAUSERDOCS/*" })
public class ICMAUSERDOCS extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response, boolean content)   throws IOException{
		...
		String nodepath = uri.substring(uri.indexOf("/ICMAUSERDOCS")); //Remove /ICMAUSERDOCS/
		try{
