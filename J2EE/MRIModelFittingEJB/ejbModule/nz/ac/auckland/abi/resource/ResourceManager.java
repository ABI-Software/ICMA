...
public class ResourceManager {
	...
	private Hashtable<String, MRIModelFitting> workflowSessions;
	...
	public ResourceManager() {
		...
		workflowSessions = new Hashtable<String, MRIModelFitting>();
	...
	public void associateSession(String workflowID, MRIModelFitting session) {
		workflowSessions.put(workflowID, session);
	}

	public MRIModelFitting getSession(String workflowID) {
		try {
