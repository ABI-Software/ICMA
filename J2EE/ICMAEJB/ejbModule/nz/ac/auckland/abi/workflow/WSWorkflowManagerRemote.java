...
@Remote
public interface WSWorkflowManagerRemote {
	...
	public JSONObject fitMRIModel(JSONObject object) throws Exception;
	//public String speckleTrackAndFit(JSONObject obj) throws Exception;
