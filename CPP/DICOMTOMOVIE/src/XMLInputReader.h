...
private:
	...
	std::vector<std::pair<std::string,std::string> > uri;
...
public:
	...
	std::string getUri(int cnt){
		std::pair<std::string,std::string>& pr = uri[cnt];
		return pr.second;
	};

	std::string getName(int cnt){
		std::pair<std::string,std::string>& pr = uri[cnt];
		return pr.first;
	};
