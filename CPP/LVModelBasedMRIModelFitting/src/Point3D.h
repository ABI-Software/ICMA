...
inline Point3D operator*(const vnl_matrix<double>& transform, const Point3D& v) {
	Point3D r;
	r.x = transform[0][0] * v.x + transform[0][1] * v.y + transform[0][2] * v.z + transform[0][3];
	r.y = transform[1][0] * v.x + transform[1][1] * v.y + transform[1][2] * v.z + transform[1][3];
	r.z = transform[2][0] * v.x + transform[2][1] * v.y + transform[2][2] * v.z + transform[2][3];
