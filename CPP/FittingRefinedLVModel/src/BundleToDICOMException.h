...
#ifndef BUNDLETODICOMEXCEPTION_H_
#define BUNDLETODICOMEXCEPTION_H_
...
/**
 This is BundleToDICOMException exception class
 */
class BundleToDICOMException: public std::exception {
public:
	/**
	 Construct an exception with a message
	 */
	BundleToDICOMException(const std::string& details);
	~BundleToDICOMException() throw ();
...
#define SAFTHROW( message ) 											\
	{																		\
		...
		throw BundleToDICOMException( full_message.str() );								\
	}
